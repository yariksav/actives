...
class SimpleImage
{
    ...
    function load($filename) {
        ...
        $this->image_original = $this->image;
    }
    ...
    function getWidth() {
        return imagesx($this->image_original);
    }

    function getHeight() {
        return imagesy($this->image_original);
    }
    ...
    function resize($width, $height) {
        $this->image = $this->image_original;
    ...
    function resizeTo($size) {
        ...
        if ($height > $size) {
            $proportion = max($proportion, $height / $size);
        }

        if ($proportion <= 1) {
            $proportion = 1;
        }
        $this->resize($width/$proportion, $height/$proportion);
    }
//
//    function resizeToHeight($size) {
//        $width = $this->getWidth();
//        $height = $this->getHeight();
